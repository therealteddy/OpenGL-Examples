...
unsigned int vbo, vao, ebo, sp;

int main(int argc, char** argv) {
    GLFWwindow* win = window(800, 600, "Rainbow Rectangle", 3, 3, GLFW_OPENGL_CORE_PROFILE, GLFW_FALSE);
    glClearColor(0.125f, 0.0625f, 0.25f, 1.0f);
